namespace NServiceBus
{
    ...
    class SecondLevelRetriesNoTransactionBehavior : ForkConnector<ITransportReceiveContext, IRoutingContext>
    {
        public SecondLevelRetriesNoTransactionBehavior(SecondLevelRetryPolicy retryPolicy, string localAddress)
        {
        ...
        static ILog Logger = LogManager.GetLogger<SecondLevelRetriesNoTransactionBehavior>();

        public class Registration : RegisterStep
        {
            public Registration()
                : base("SecondLevelRetries", typeof(SecondLevelRetriesNoTransactionBehavior), "Performs second level retries")
            {
